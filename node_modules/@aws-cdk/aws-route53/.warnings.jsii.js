...
function _aws_cdk_aws_route53_HostedZoneProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.vpcs))
            require("@aws-cdk/aws-ec2/.warnings.jsii.js")._aws_cdk_aws_ec2_IVpc(p.vpcs);
    }
    finally {
...
function _aws_cdk_aws_route53_SrvRecordProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.values))
            _aws_cdk_aws_route53_SrvRecordValue(p.values);
        if (!visitedObjects.has(p.zone))
            _aws_cdk_aws_route53_IHostedZone(p.zone);
    }
    finally {
...
function _aws_cdk_aws_route53_CaaRecordProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.values))
            _aws_cdk_aws_route53_CaaRecordValue(p.values);
        if (!visitedObjects.has(p.zone))
            _aws_cdk_aws_route53_IHostedZone(p.zone);
    }
    finally {
...
function _aws_cdk_aws_route53_MxRecordProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.values))
            _aws_cdk_aws_route53_MxRecordValue(p.values);
        if (!visitedObjects.has(p.zone))
            _aws_cdk_aws_route53_IHostedZone(p.zone);
    }
    finally {
...
function _aws_cdk_aws_route53_CfnHealthCheckProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.healthCheckConfig))
            _aws_cdk_aws_route53_CfnHealthCheck_HealthCheckConfigProperty(p.healthCheckConfig);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_aws_route53_CfnHostedZoneProps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.hostedZoneTags))
            _aws_cdk_aws_route53_CfnHostedZone_HostedZoneTagProperty(p.hostedZoneTags);
    }
    finally {
        visitedObjects.delete(p);
    }
