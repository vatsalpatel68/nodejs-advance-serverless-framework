...
Metric[_a] = { fqn: "@aws-cdk/aws-cloudwatch.Metric", version: "1.159.0" };
function asString(x) {
    if (x === undefined) {
        return undefined;
    }
...
MathExpression[_b] = { fqn: "@aws-cdk/aws-cloudwatch.MathExpression", version: "1.159.0" };
/**
