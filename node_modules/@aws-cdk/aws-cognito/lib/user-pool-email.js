...
UserPoolEmail[_a] = { fqn: "@aws-cdk/aws-cognito.UserPoolEmail", version: "1.159.0" };
    ...
    _bind(scope) {
        ...
        return {
            ...
            sourceArn: core_1.Stack.of(scope).formatArn({
                service: 'ses',
                resource: 'identity',
                resourceName: encodeAndTest((_b = this.options.sesVerifiedDomain) !== null && _b !== void 0 ? _b : this.options.fromEmail),
                region: (_c = this.options.sesRegion) !== null && _c !== void 0 ? _c : region,
            }),
        };
    }
}
