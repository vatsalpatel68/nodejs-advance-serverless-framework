    ...
    _synthesizeTemplate(session, lookupRoleArn) {
        ...
        if (this.maxResources > 0) {
            ...
            if (numberOfResources > this.maxResources) {
                const counts = Object.entries(count(Object.values(resources).map((r) => `${r === null || r === void 0 ? void 0 : r.Type}`))).map(([type, c]) => `${type} (${c})`).join(', ');
...
Stack[_a] = { fqn: "@aws-cdk/core.Stack", version: "1.159.0" };
